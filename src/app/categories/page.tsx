          ...
          <main className="w-full">
            ...
            <div className="mb-8">
              <div className="mb-3 text-sm text-slate-600">
                <Link href="/" className="hover:text-slate-900">Home</Link> / <Link href="/categories" className="hover:text-slate-900">Categories</Link> / <span className="font-semibold text-slate-900">All Categories</span>
              </div>
              <div className="flex items-start justify-between gap-6">
                <div>
                  <h1 className="text-4xl font-bold text-slate-900 mb-2">Fashion Categories</h1>
                  <p className="text-slate-600">Discover our wide range of fashion across top styles, dresses, and traditional collections.</p>
                </div>
